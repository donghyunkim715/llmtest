      ...
      <div className="bg-[#181c24] rounded-xl p-5 border border-[#262a33] max-w-2xl space-y-4 font-mono text-xs">
        ...
        <div className="pt-2">
          <button
            ...
            className="px-4 py-2 bg-[#8083ff] text-[#0d0096] font-bold rounded-lg hover:bg-[#686bff] hover:text-white transition-colors"
          >
            설정 저장
          </button>
          {toast && <span className="ml-3 text-[#4edea3]">설정이 성공적으로 저장되었습니다.</span>}
        </div>
      </div>
    </div>
  );
